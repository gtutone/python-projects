...
def playGame(wordList):
    ...
    while True:
        ...
        if playerChoice == 'n':
            while True:
                # Let player choose if they or the computer wants to play
                humanComp = input('Enter u to have yourself play, c to have the computer play: ')
                # If human, play hand as human
                if humanComp == 'u':
                ...
                # Play hand as computer
                    ...
                    break
                # Throw invalid command for any other input
                else:
